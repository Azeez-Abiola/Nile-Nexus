...
import logoImage from '/images/nilenexus1.png'
    ...
    <footer className="bg-navy text-white">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              ...
              we deliver scalable, modern solutions for UK businesses.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="mailto:info@nilenexus.co.uk" className="hover:text-primary-500 transition-colors">
                  info@nilenexus.co.uk
                </a>
              </li>
              <li>
                <a href="tel:+441234567890" className="hover:text-primary-500 transition-colors">
                  +44 123 456 7890
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-300">
          <p>&copy; {currentYear} Nile Nexus Talents Ltd. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
